<?php
// clipes/api/cloudinary_upload.php
// BIBLIOTECA PARA UPLOAD NO CLOUDINARY

function uploadToCloudinary($filePath, $folder = 'videos', $resourceType = 'video') {
    ...
    $timestamp = time();
    $publicId = $folder . '/' . pathinfo($filePath, PATHINFO_FILENAME);
    ...
    return $result['secure_url']; // Retorna URL pública
}
